# -*- coding: utf-8 -*-
"""ModeloLogisticoSepsisSOFA.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PkKmebHUezaBY8GdcRBv74-eX__jXkoa

# MODELO LOGISTICO Sepsis SOFA
...
groups = ModeloEjecutado.groupby(ModeloEjecutado.Paciente)
...
for i in range(0,len(ModeloEjecutado)):

  if ModeloEjecutado.loc[i, 'Paciente'] == 'p000897':
     if ModeloEjecutado.loc[i, 'SepsisLabel'] == 1:
        num1= ModeloEjecutado.loc[i, 'Hora']
        break
   
for i in range(0,len(ModeloEjecutado)):

  if ModeloEjecutado.loc[i, 'Paciente'] == 'p000897':
     if ModeloEjecutado.loc[i, 'Prediction_SOFA'] == 1:
        num2= ModeloEjecutado.loc[i, 'Hora']
        break
...
for i in range(0,len(ModeloEjecutado)):
  ...
  if ModeloEjecutado.loc[i, 'Paciente'] == 'p001040':
     if ModeloEjecutado.loc[i, 'SepsisLabel'] == 1:
        num3= ModeloEjecutado.loc[i, 'Hora']
        break
...
for i in range(0,len(ModeloEjecutado)):
  ...
  if ModeloEjecutado.loc[i, 'Paciente'] == 'p001040':
     if ModeloEjecutado.loc[i, 'Prediction_SOFA'] == 1:
        num4= ModeloEjecutado.loc[i, 'Hora']
        break
